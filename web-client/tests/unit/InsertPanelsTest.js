...
describe("InsertPanels", () => {
    it("sets interaction class on insert panels if interaction is required", () => {
        ...
        let insertPanelsHtml = insertPanels.findAll(".insert-location");
        expect(insertPanelsHtml.is(".insert-location--interaction")).toBe(true);
    });
    ...
    it("enables all insert panels but the one which is disabled in props: disabledInsertLocation", () => {
        ...
        let insertPanelsHtml = insertPanels.findAll(".insert-location--disabled");
